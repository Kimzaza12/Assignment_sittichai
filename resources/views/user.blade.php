    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('user') }}">User</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="container text-center mt-4">
                <div class="row row-cols-3 ">
                    @foreach ($assignmentuser as $ument)
                        ...
                        <div class="box mt-5 pt-2 text-start  ms-sm-2 " style="background-color: #2989f7 ; max-width: 400px; border-radius: 10px;" >
